...
#define ORG "3ru070"             // For a registered connection, replace with your org
#define ID "photocontroller"                        // For a registered connection, replace with your id
#define AUTH_TOKEN "k!7TUXREnh_NE5uKfa"                // For a registered connection, replace with your auth-token
...
int publish(MQTT::Client<MQTTEthernet, Countdown, MQTT_MAX_PACKET_SIZE>* client, MQTTEthernet* ipstack)
{
    ...
    //KLM 08/10/2015  "{\"d\":{\"temp\":%0.4f,\"DAC_Value\":%hu,\"State\":%#x,\"Power\":%u,\"Old_Power\":%u,\"wJourTimer\":%hu,\"wNuitTimer\":%hu,\"wCurrentTimer\":%hu,\"Rotary_mode\":%x,\"v_iphoto\":%hx,\"v_vphoto\":%hx,\"v_bat\":%hx,\"bNuit\":%x}}",
   //         sensor.temp(),PHC.getDAC_Value(),PHC.getState(), PHC.getPower(), PHC.getOld_power(), PHC.getWJourTimer(), PHC.getWNuitTimer(),PHC.getWCurrentTimer(), PHC.getRotary_mode(), PHC.getV_iphoto(), PHC.getV_vphoto(),PHC.getV_bat(), PHC.getBNuit());
//Ben 09/10/2015
    sprintf(buf,
    "{\"d\":{\"myName\":\"IoT mbed\",\"DAC_Value\":%hu,\"State\":1,\"Power\":%u,\"Old_Power\":%u,\"v_iphoto\":%hu,\"v_vphoto\":%hu,\"v_bat\":%i,\"Rotary_mode\":%x,\"bNuit\":%x,\"wJourTimer\":%hu,\"wNuitTimer\":%hu,\"wCurrentTimer\":%hu,\"Loudness\":%f,\"Light\":%2.2f,\"Motion\":%d}}",
PHC.getDAC_Value(), PHC.getPower(),PHC.getOld_power(),PHC.getV_iphoto(),PHC.getV_vphoto(),PHC.getV_bat(),PHC.getRotary_mode(),PHC.getBNuit(),PHC.getWJourTimer(),PHC.getWNuitTimer(),PHC.getWCurrentTimer(),loudness.read(),light_sensor.read(),motion.read());
    
    
    //klm 25/10
    //sprintf(buf,
    //"{\"d\":{\"myName\":\"IoT mbed\",\"DAC_Value\":%hu,\"State\":%x,\"Power\":%u,\"Old_Power\":%u,\"v_iphoto\":%hu,\"v_vphoto\":%hu,\"v_bat\":%i,\"Rotary_mode\":%x,\"bNuit\":%x,\"wJourTimer\":%hu,\"wNuitTimer\":%hu,\"wCurrentTimer\":%hu,\"Loudness\":%f,\"Light\":%2.2f,\"Motion\":%d}}",
//PHC.getDAC_Value(),PHC.getState(),PHC.getPower(),PHC.getOld_power(),PHC.getV_iphoto(),PHC.getV_vphoto(),PHC.getV_bat(),PHC.getRotary_mode(),PHC.getBNuit(),PHC.getWJourTimer(),PHC.getWNuitTimer(),PHC.getWCurrentTimer(),loudness.read(),light_sensor.read(),motion.read());
    
    //,\"DAC_Value\":%hu,\"State\":%#x,\"Power\":%u,\"Old_Power\":%u,\"v_iphoto\":%hx,\"v_vphoto\":%hx,\"v_bat\":%hx,\"Rotary_mode\":%#x,\"bNuit\":%#x,\"wJourTimer\":%hu,\"wNuitTimer\":%hu,\"wCurrentTimer\":%hu
    //, PHC.getDAC_Value(),PHC.getState(), PHC.getPower(), PHC.getOld_power(), PHC.getV_iphoto(), PHC.getV_vphoto(),PHC.getV_bat(), PHC.getRotary_mode(), PHC.getBNuit(), PHC.getWJourTimer(), PHC.getWNuitTimer(),PHC.getWCurrentTimer()
